...
There are many different kinks of loops but they all do roughly the same thing:
    For statement
    do while
    while
    labeled
...
//loop stucture: a) creation of an indexing variable b) a run condition c) change to the indexing variable
