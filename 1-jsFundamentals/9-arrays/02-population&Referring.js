...
// console.log(food);
// food.splice(2, 0, 'Sweet Potatol Pie');
...
//second number is the stop position (no to be included)-
// console.log(food);

//forEach allows us to iterate with loops specifically, and we directly grab both the elements
...
//flip the values within the array (what was in index 4 is now 0, 3 to 1, etc
//using a method only, lets print the values of the new arranged array
