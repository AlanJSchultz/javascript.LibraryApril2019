//for-in example 1
//console.log 0 thru 9
for (let i = 0; i < 10; i++) {  
    console.log(i);  //this output shows the position of the elements in the array
}
...
//mini-challenge
//make a function that takes 2 parameters: favFood & favDessert.
...
console.log(favorites('crunchy peanutbutter', 'rocky road'));
console.log(favorites('rueven', 'coffee cake'));
...
//Challenge 3:
//make 2 functions. 
//the first function takes a function as input , and calls that input function with a number value. 
//the second function takes a number as input, and concatenates that number with a string. 
