...
//Undefined
/*
Undefined usually means a variable has been declared, but it's not been declared a value
*/
...
are for gag gifts that are boxes intentionally given with nothing inside (because thats the gag).
...
Denoted by {}
Have keys and values--color (key): 'blue' (value), seperated with a colon, each
